...
function RegistrationPage() {
  ...
  return (
    ...
    //     </p>
    //     <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600">Je crée mon compte</button>
    //   </form>


    //   <Link href="/">
    //     <div className="flex justify-center mt-4 text-gray-500 text-sm ">Mention légales</div>
    //   </Link>

    // </div>
    <div className={`navigation${true ? " active" : ""} bg-gray-100 p-4 border rounded-lg shadow-lg`}>
    <div className="menuToggle" >ccccc</div>
      {/* <Link href="/" className="flex items-center justify-center ">
        <FiChevronLeft/><div className="mr-1 "/><div>Connexion</div>  
      </Link> */}
    </div>
  );
}
