        ...
        <section className="fixed bottom-0 z-10 w-full  bg-white">
            <div className="flex  justify-between items-center border-t-2  border-gray-100 px-10 py-5  md:hidden">
                <Link
                    ...
                    href="/"
                >
                    <span className="h-6 w-6"><HiOutlineHome /></span>
                </Link>
                <Link
                    href="/user/favorites"
                    className={
                ...
                >
                    <span className="h-6 w-6"><AiOutlineHeart /></span>
                </Link>
                ...
                >
                    ...
                    <span className="h-6 w-6"><HiOutlineShoppingCart /></span>
                </Link>
                ...
                >
                    ...
                    <span className="h-6 w-6"><HiOutlineUser /></span>
                </Link>
